...
function page() {
  ...
  <div className="flex flex-col items-center border-b  py-4 sm:flex-row sm:px-10 lg:px-20 xl:px-32">
    <div className="text-4xl font-bold text-gray-800">Checkout</div>
  ...
  <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
    ...
    <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
      ...
      <Link href="/products">
        <button className="mt-4 mb-8 w-full rounded-md bg-red-600 px-6 py-3 font-medium text-white">Cancel</button>
      </Link>
    </div>
  </div>
</div>
